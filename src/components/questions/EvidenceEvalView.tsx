  ...
  return (
    <div className="w-full flex flex-col space-y-3.5">
      ...
      <div className="bg-white rounded-2xl border-2 border-stone-200 shadow-sm overflow-hidden">
        <div className="bg-purple-50 border-b border-purple-200 px-4 sm:px-5 py-2.5 flex items-center justify-between">
          ...
          <span className="text-xs font-bold px-2.5 py-0.5 rounded-full bg-white text-purple-900 border border-purple-300">
            {question.sourceType}
          </span>
        </div>
        ...
        <div className="p-3.5 sm:p-4">
          ...
          <p className="text-sm font-serif text-stone-800 leading-relaxed bg-stone-50 p-3 rounded-xl border border-stone-200 italic">
